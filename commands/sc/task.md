---
name: task
description: "복잡한작업, 워크플로우관리, 태스크위임, 다중에이전트조율, 프로젝트관리, 계층적분해, 병렬실행, 크로스세션지속성, 아키텍트페르소나, 프론트엔드페르소나, 백엔드페르소나, 보안페르소나, DevOps페르소나, 지능형라우팅, 품질게이트, 진행상황추적으로 고도화된 태스크 관리 시스템을 제공하는 명령어"
category: special
complexity: advanced
